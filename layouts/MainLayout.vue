<template>
    <div id="MainLayout" class="w-full fixed z-50">
        <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
            <ul
                class="flex items-center mx-auto justify-end text-xs text-[#333333] font-light px-2 h-10 bg-[#FAFAFA] max-w-[1200px]"
            >
                <li
                ...
                >
                    ...
                    <div
                        id="AccountMenu"
                        class="absolute bg-white text-[#333333] w-[220px] z-40 top-[38px] -left-[100px] border-x border-b"
                        v-if="isAccountMenu"
                    >
                        <div
                            v-if="!user"
                            class="text-semibold text-[15px] my-4 px-3"
                        >
            ...
            >
                ...
                <div class="max-w-[700px] w-full md:block hidden">
                    <div class="relative">
                        ...
                        <div
                            class="border absolute bg-white max-w-[700px] h-auto w-full rounded-md"
                        >
                            <div
                                class="p-1"
                            ...
                            >
                                <NuxtLink
                                    :to="`/item/${item.id}`"
                                    class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-100 hover:rounded-md"
                                >
